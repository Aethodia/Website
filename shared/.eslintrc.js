...
module.exports = {
    ...
    rules: {
        ...
        "no-eq-0": 0, // disallow `0` comparisons without type-checking operators
        ...
        "no-undef-init": 0, // disallow initializing variables to `0`
        "no-0": 0, // disallow the use of `0` as an identifier
